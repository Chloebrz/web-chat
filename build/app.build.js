...
},{"./components/ChatBox":149,"react":147}],149:[function(require,module,exports){
/*** @jsx React.DOM */
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "messagelist"}, 
                React.createElement("h1", null, "Super Chat"), 
                React.createElement("h3", null, "Using socket.io and react.js"), 
...
},{"./ChatForm":150,"./MessagesList":152,"./UsersList":153,"react":147}],150:[function(require,module,exports){
/*** @jsx React.DOM */
...
var ChatForm = React.createClass({displayName: 'ChatForm',
    ...
    render: function() {
        ...
        return (
            React.createElement("form", {className: "chatForm", onSubmit: this.handleSubmit}, 
                React.createElement("input", {type: "text", placeholder: "Your message...", size: "50", ref: "new_message"}), 
                React.createElement("br", null), 
                React.createElement("input", {type: "submit", value: "Send", className: "button"})
            )
        );
    }
});
    ...
    render: function() {
        ...
        return (
            React.createElement("p", null, 
                React.createElement("span", {className: "date"}, "[", this.props.date.toLocaleTimeString(), "] "), React.createElement("em", null, this.props.user), " - ", this.props.text
            )
        );
    }
});
...
var MessagesList = React.createClass({displayName: 'MessagesList',
    ...
    getMessageNodes : function() {
        ...
        return this.props.messages.map(function (message) {
            ...
            return (
                React.createElement(Message, {date: message.date, user: message.user, text: message.text})
            );
        });
    },
...
},{"./Message":151,"react":147}],153:[function(require,module,exports){
/*** @jsx React.DOM */
...
},{"react":147}]},{},[148,149,150,151,152,153]);
